...
namespace LeaveManagement.Persistance.Migrations
{
    ...
    [Migration("20240330101011_SeedingLeaveTypes")]
            ...
            modelBuilder.Entity("LeaveManagement.Domain.LeaveType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "PK",
                            DateCreated = new DateTime(2024, 3, 30, 15, 40, 10, 918, DateTimeKind.Local).AddTicks(6563),
                            DefaultDays = 10,
                            LastModifiedBy = "PK",
                            LastModifiedDate = new DateTime(2024, 3, 30, 15, 40, 10, 918, DateTimeKind.Local).AddTicks(6573),
                            Name = "Vacation"
                        },
                        new
                        {
                            Id = 2,
                            CreatedBy = "PK",
                            DateCreated = new DateTime(2024, 3, 30, 15, 40, 10, 918, DateTimeKind.Local).AddTicks(6575),
                            DefaultDays = 12,
                            LastModifiedBy = "PK",
                            LastModifiedDate = new DateTime(2024, 3, 30, 15, 40, 10, 918, DateTimeKind.Local).AddTicks(6576),
                            Name = "Sick"
                        });
                });
